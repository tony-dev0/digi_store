...
const cartSlice = createSlice({
  ...
  reducers: {
    ...
    addItemToCart(state, action: PayloadAction<CartItem>) {
      ...
      } else { console.log('else push to cart')
...
// Export actions
export const { addItemToCart, removeItemFromCart, clearCart, increaseItemQuantity, decreaseItemQuantity, updateItemQuantity } = cartSlice.actions;
