...
const Users = () => {
  ...
  const columns:GridColDef<TabletypeGrid>[] = useMemo(
    () => [ 
      ...
      { field: "email", headerName: "Email", width: 200, editable: true, align:'center',
        headerAlign:'center'
       },
      {
        field: "username",
      ...
      },
      {
        ...
        width: 80,
        type: "actions",
        renderCell: (params: any) => <SaveAction {...{ params, rowId, setRowId }} />,
        sortable: false,
        filterable: false,
      },
      {
 ...
 const onSubmit: SubmitHandler<FormFields> = async (data: FormFields) => {
    ...
    .catch((error) => {
      ...
      (error.response.data).length > 30 ? toast.error("failed to register") :  toast.error(error.response.data)
    })
  }
  return (
    <>
    <div className="px-2">
      ...
      >
        <DataGrid
          ...
          getRowClassName={(params:any) => params.indexRelativeTourrentPage % 2 === 0 ? 'even' : 'odd'}
