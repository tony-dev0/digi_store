    ...
    <div>
        <div className="row justify-content-center gap-4">
         ...
         <div className="img-content col-lg-4 py-3">
                         ...
                         { productLoading ? (<Skeleton variant="rectangular" width={300}/>) : <img className="img-front" src={require("../../../assets/"+specifiedProduct?.photos[active])}  alt="" width="" />}                           <i className="fa fa-arrow-circle-right fa-2x" aria-hidden="true"></i>
       ...
       <div className='mt-3 d-flex justify-content-center gap-5'>
          <button className='py-2 px-5 btn btn-customx' onClick={handleShow}> Edit</button> 
          <button className='py-2 px-5 btn btn-danger' onClick={openModal}> Delete</button>
       </div> 
