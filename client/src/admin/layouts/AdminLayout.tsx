...
import { storeProducts, storeUsers, setproductLoader } from '../../redux/admin/adminSlice';
    ...
    <div>
      ...
      <List>
        {[
          ...
          <Link to={"/admin/" + text.toLowerCase().replace(" ", "-")}>
            <ListItem
            ...
            >
              <ListItemButton>
                ...
                >
                  ...
                  {index === 3 && <MailIcon />}
                  {index === 4 && <CalenderMonthIcon />}
                  {index === 5 && <SettingsSuggestionIcon />}
                </ListItemIcon>
      ...
      <Divider />
         <div className="d-flex justify-content-center w-100">
              <button className='mt-5 py-2 px-4 btn btn-customx'>Logout Session</button>
          </div> 
    </div>
  );
...
{/* modal start */}
 ...
 <Modal show={show} onHide={handleModalClose} style={{zIndex:9999}}>
        ...
        <Modal.Footer>
          <button className="py-2 px-4 btn btn-customx" onClick={handleModalClose}>
            Close
          </button>
        </Modal.Footer>
      </Modal>
