...
export const createProduct = async (req, res, next) => {
  await upload(req, res, (err) => {
    ...
    let newPath1 = path.join("/images", imageName1);
    ...
    let newPath2 = path.join("/images", imageName2);
    ...
    let newPath3 = path.join("/images", imageName3);
    ...
    let newPath4 = path.join("/images", imageName4);
    ...
    try {
      const newProduct = new Product({
        ...
        prevprice: Number(req.body.price) + 2210,
